...
for j=1:8
    ...
    relation2 = (relation2temp(2:6)).^(1/2.016375);
...
writematrix(R2slopep, 'a5_R2slopep_3fit.txt');
writematrix(R2yinterceptp, 'a5_R2yinterceptp_3fit.txt');
writematrix(R3slopep, 'a5_R3slopep_3fit.txt');
writematrix(R3yinterceptp, 'a5_R3yinterceptp_3fit.txt');