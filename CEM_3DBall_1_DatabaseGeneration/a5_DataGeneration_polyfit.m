...
writematrix(R2slopep, 'a5_R2slopep_5fit_With0.txt');
writematrix(R2yinterceptp, 'a5_R2yinterceptp_3fit_With0.txt');
writematrix(R3slopep, 'a5_R3slopep_3fit_With0.txt');
writematrix(R3yinterceptp, 'a5_R3yinterceptp_3fit_With0.txt');
